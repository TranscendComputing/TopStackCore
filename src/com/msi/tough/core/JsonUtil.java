...
public class JsonUtil {
    ...
    public static String accBeansToJsonList(final List<AccountBean> l)
        ...
        for (AccountBean ac : l) {
            // A bit weak, but if access key is null or blank, we assume it's
            // the system-account, and skip it;
    ...
    public static String accBeanToJsonObject(final AccountBean ac)
            throws IOException {
        final StringWriter sw = new StringWriter();
        final JsonFactory jfactory = new JsonFactory();
        final JsonGenerator json = jfactory.createJsonGenerator(sw);
    ...
    public static void accBeanToJsonObjectHelper(final JsonGenerator json,
            final AccountBean ac) throws JsonGenerationException, IOException {
